...
// Démarrer la session
session_start();
require_once $_SERVER['DOCUMENT_ROOT'] . '/Site-Vitrine/php/config/database.php';
...
$relativePath = "../../";
$returnUrl = isset($_GET['redirect']) ? $_GET['redirect'] : '/Site-Vitrine/public/pages/Accueil.php';
...
if (!filter_var($returnUrl, FILTER_VALIDATE_URL) && strpos($returnUrl, '../') === false) {
    ...
    header('Location: ' . $relativePath . '/Site-Vitrine/public/pages/Accueil.php');
}
